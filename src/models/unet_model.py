    ...
    def __init__(self, in_channels = 4, out_channels = 4, num_blocks = 2, time_emb_dim = 128, features=[128, 256, 512]):
        ...
        for next_channels in features[1:]:
            ...
            for _ in range(num_blocks):
                block = ResBlock(current_channels, time_embed_dim=time_emb_dim, num_groups = 32, self_attention=use_attn)
        ...
        for i in range(len(reversed_features) - 1):
            ...
            for j in range(num_blocks):
                ...
                block = ResBlock(in_channels = block_in, out_channels = out_channels_level, time_embed_dim=time_emb_dim, num_groups = 32, self_attention=use_attn)
                level_blocks.append(block)
